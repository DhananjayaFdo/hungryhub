...
class LoadProductBloc extends Bloc<LoadProductEvent, LoadProductState> {
  LoadProductBloc() : super(LoadProductInitial()) {
    on<MoreProductLoadState>(moreProductLoadState);
  }

  FutureOr<void> moreProductLoadState(MoreProductLoadState event, Emitter<LoadProductState> emit) async {
    ...
    products.fold((l) {
      ...
      if (r.data.isEmpty) {
        ...
        ProductProvider pro = Provider.of(event.context, listen: false);
